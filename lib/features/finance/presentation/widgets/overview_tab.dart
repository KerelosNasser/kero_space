...
class OverviewTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (var stock in state.watchlist) {
      final price = state.tickerPrices[stock.ticker] ?? 0;
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                const Text('NET WORTH', style: TextStyle(color: Colors.white70, fontSize: 12, fontWeight: FontWeight.bold, letterSpacing: 1.2)),
              ...
              if (index == state.moneySources.length) {
                return Card(
                  ...
                  child: InkWell(
                    ...
                    child: const Center(child: Icon(Icons.add, size: 28, color: AppTheme.accentMint)),
                  ),
                );
              }
              ...
              return Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(source.name, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: AppTheme.textSecondary)),
                      const SizedBox(height: 4),
                      Text('${source.balance.toStringAsFixed(2)} EGP', style: const TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ),
              );
          ...
          const Text('Top Stocks Watchlist', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          const SizedBox(height: 8),
          state.watchlist.isEmpty
              ? const Card(
                  ...
                  child: Padding(
                    ...
                    child: Text('Your watchlist is empty. Add stocks in the Stocks tab.', textAlign: TextAlign.center, style: TextStyle(color: AppTheme.textSecondary)),
                  ),
                )
              : GridView.builder(
                  shrinkWrap: true,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      const Row(
                        children: [
                          ...
                          SizedBox(width: 8),
                          Text('AI Insights', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: AppTheme.accentCyan)),
                        ],
                      ),
                      IconButton(
                  ...
                  const SizedBox(height: 8),
                  Text(state.aiAdvice!, style: const TextStyle(fontSize: 13, height: 1.4, color: AppTheme.textSecondary)),
                ],
              ),
            ),
      ...
      builder: (ctx) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              TextField(
                decoration: const InputDecoration(labelText: 'Source Name (e.g. Freelancing)'),
                onChanged: (val) => name = val,
              ),
              const SizedBox(height: 8),
              TextField(
                decoration: const InputDecoration(labelText: 'Initial Balance (EGP)'),
            ...
            ElevatedButton(
              onPressed: () {
                if (name.trim().isNotEmpty) {
                  context.read<FinanceBloc>().add(AddMoneySourceEvent(name.trim(), balance));
                  Navigator.pop(ctx);
                }
              },
